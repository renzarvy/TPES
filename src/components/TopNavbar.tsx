  ...
  return (
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs print:hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center space-x-3">
          ...
          <div className="h-4 w-[1px] bg-slate-200 hidden sm:block" aria-hidden="true" />
        ...
        <nav aria-label="Portal section navigation" className="flex items-center overflow-x-auto py-1 scrollbar-none gap-1 sm:gap-2">
